...
COIN_TGZ='https://github.com/eastcoastcrypto/Civitas/releases/download/v1.2.2/civitas-1.2.2-x86_64-linux-gnu.tar.gz'
COIN_ZIP='civitas-1.2.2-x86_64-linux-gnu.tar.gz'
COIN_NAME='civitas'
COIN_PORT=18843
RPC_PORT=18844
